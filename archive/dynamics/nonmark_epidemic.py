...
class SIkSNetwork(Dynamical_Network):
    ...
    """
    def __init__(self, graph, infection_prob, recovery_prob, K,
                 init_active=0.01, filename=None, full_data_mode=False):
        ...
        self.infected_time = {}
        super(SIkSNetwork, self).__init__(graph, filename=filename,
