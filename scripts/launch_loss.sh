...
echo "Submitted by launch_loss.sh"
# ---------------------------------------------------------------------
echo ""
...
then
    PATH_TO_EXP="$HOME/Documents/ulaval/doctorat/projects/dynalearn/data/loss_analysis"
...
python ${PATH_TO_SCRIPT}/loss_analysis.py -p ${PATH_TO_EXP}/${FILENAME}/parameters.json
