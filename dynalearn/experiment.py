...
class Experiment:
    ...
    def save_hdf5_data(self, h5file):
        ...
        for g_name in self.data_generator.graphs:
            inputs = self.data_generator.inputs[g_name]
            adj = self.data_generator.graphs[g_name]
    ...
    def load_hdf5_data(self, h5file):
        for k, v in h5file["/data/"].items():
            self.data_generator.graphs[k] = v["adj_matrix"][...]
            self.data_generator.inputs[k] = v["inputs"][...]
