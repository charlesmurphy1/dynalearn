...
class Statistics(object):
    ...
    **Parameters**
    ...
    colors : List : (default = ``None``)
        List of two colors for plot display. If ``None``, default value is [``'#2166ac'``, ``'#d6604d'``]
    ...
    def evaluate(self, update, data, model):
        ...
        **Parameters**
        ...
        ..note::
            Usually generated by a ``Trainer`` object, it contains the keys [``"train"``, ``"val"``, ``"grad"``]
            corresponding to the training dataset, validation dataset and the gradient of each parameter.
    ...
    def is_better(self, update1, update2):
        ...
        ..note::
            This method must be initialized when object Statistics is to be used for early stopping.
        ...
        **Returns**
        check_if_better : Bool
            If ``True``, statistics in update1 is better than statistics in update2.
    ...
    def plot_stat(self, path=None, best=None):
        ...
        **Parameters**
        ...
        best : Integer : (default = ``None``)
            Update of best statistics. If ``None``, it does not render best update location on plot.
...
class Training_Statistics(Statistics):
    ...
    **Parameters**
    ...
    colors : List : (default = ``None``)
        List of two colors for plot display. If ``None``, default is [``#2166ac``, ``#d6604d``].
    ...
    def __init__(self, strname, filename, colors=None, ext=".png", graining=2, makeplot=False, precision=4):
        ...
        super(Training_Statistics, self).__init__(strname, filename, colors, ext, makeplot, precision)
        self.stat = {"train": {}, "val":{}}
    ...
    def plot_stat(self, path=None, best=None):
        ...
        **Parameters**
        ...
        self.ax.plot(update_stat, train_stat, marker='o', markeredgewidth=1., markeredgecolor="k", linestyle='-',
                     color=self.colors[0], lw=1., alpha=1)
        self.ax.plot(update_stat, val_stat, marker='o', markeredgewidth=1., markeredgecolor="k", linestyle='-',
    ...
    **Parameters**
    ...
    def estimate(self, update, data, model):
        ...
        **Returns**
        ...
        ..note::
            For Distribution_statistics object, estimate() returns ``None``, because it cannot be estiamted.
    ...
    def save_stat(self, path):
        ...
        **Parameters**
        ...
        ..note::
            For Distribution_Statistics, save_stat() saves nothing. Therefore, it only returns ``None``.
